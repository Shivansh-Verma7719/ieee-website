            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-sm text-[#d47557] font-bold">
                <a href={`mailto:${faculty.email}`}>
                  <Image src="https://static.vecteezy.com/system/resources/previews/020/009/614/large_2x/email-and-mail-icon-black-free-png.png" alt="Email" className="inline w-6 h-6 mr-1" />
                </a>
              </p>
            </div>
          </div>
