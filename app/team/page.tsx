...
export default function Home() {
  ...
  return (
    <div className="min-h-screen p-12 gap-25 sm:p-20 font-[family-name:var(--font-geist-sans)]">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-sm text-[#d47557] font-bold">
                ...
                <a href={`:${faculty.website}`}>
                  <Image
                    src="https://icon-library.com/images/white-website-icon-png/white-website-icon-png-0.jpg"
                    alt="Website"
                    width={20}
                    height={20}
      ...
      <h1 className="text-center text-4xl font-bold mt-12 mb-8">
        General Members
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {General.map((General, index) => (
          <div
            key={index}
            className="bg-white shadow-lg rounded-lg p-10 flex flex-col items-center"
          >
            <div className="border-5 border-[#467eb5] p-5 rounded-full">
              <Image
                className="rounded-full"
