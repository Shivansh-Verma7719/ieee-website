          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="text-2xl md:text-5xl font-semibold text-neutral-700 my-4 dark:text-white"
              >
                {card.title}
              </motion.p>
              <motion.p
                layoutId={layout ? `content-${card.content}` : undefined}
                className="text-white my-2 text-sm md:text-base font-medium text-left"
              >
                {card.content}
              </motion.p>
